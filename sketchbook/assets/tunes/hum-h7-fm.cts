(tune version: 1 name: "hum-h7-fm" tempo: 60 speed: 15 channels: 6
  ...
  (instruments
    ...
    (instrument id: 2 name: "H2 D3" patch: (drone-fm level: 0.2 index: 1.6 breath-rate: 0.0213 breath-lo: 0.15 seed: 2) volume: 38 gain: 2 send: 0.35)
    ...
    (instrument id: 4 name: "H4 D4" patch: (drone-fm level: 0.35 index: 1.2 breath-rate: 0.0189 breath-lo: 0.15 seed: 4) volume: 30 gain: 2 send: 0.35)
