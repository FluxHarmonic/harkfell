(tune version: 1 name: "ring-h3" tempo: 120 speed: 4 channels: 3
  ...
  (patterns
    (pattern id: 0 rows: 16
      (row 0 (1 "A-3" 1 50 "000"))
      (row 3 (2 "A-4" 2 34 "000"))
      (row 6 (3 "E-5" 2 26 "000"))))
  (order 0)
  (history ("claude" "2026-09-24" "A3 cue: a ring-stone keyed to H2 rings in sympathy: D3 swelling, its octave and twelfth after") ("claude" "2026-09-24" "A4: for the Hollow's sealed H3 stone (content's map): the H2 cue a just fifth up")))
