(tune version: 1 name: "reedfen-bed" tempo: 60 speed: 15 channels: 8
  ...
  (patterns
    (pattern id: 0 rows: 16
      (row 0 (1 "D-4" 1 40 "000") (2 "D-4" 2 44 "000") (3 "D-4" 3 30 "000") (4 "D-3" 4 24 "000") (5 "A-3" 5 22 "000") (6 "D-4" 6 21 "000") (7 "F#4" 7 19 "000") (8 "C-5" 8 18 "000")))
    (pattern id: 1 rows: 128
      (row 127 (1 "..." 0 0 "B01"))))
  (order 0 1)
  (history ("claude" "2026-09-24" "A2: Reedfen's bed from S0's, with two drone channels, H2 (4) and H3 (5), each muted until carried") ("claude" "2026-09-24" "A4: H4, H5 and H7 on channels 6 to 8, the same voices as the Hollow's bed, so the drone is one sound in every region")))
