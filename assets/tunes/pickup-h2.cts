(tune version: 1 name: "pickup-h2" tempo: 120 speed: 4 channels: 6
  ...
  (instruments
    (instrument id: 1 name: "the harmonic joins you" patch: (bell fm-index: 1.2 fm-mod: 2.0 attack: 0.01 decay: 2.6 sustain: 0.0 release: 1.2) volume: 44 send: 0.5))
  (patterns
    (pattern id: 0 rows: 24
      (row 0 (1 "D-3" 1 44 "000"))
      (row 2 (2 "D-4" 1 38 "000"))
