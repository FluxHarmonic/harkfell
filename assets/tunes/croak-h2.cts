(tune version: 1 name: "croak-h2" tempo: 120 speed: 3 channels: 1
  ...
  (order 0)
  (history ("claude" "2026-09-24" "A3 call: carrying H2, the bellfrogs croak in its key, A3 down to D3 (A2's spot-frog)")))
