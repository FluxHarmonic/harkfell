(tune version: 1 name: "ring-h2" tempo: 120 speed: 4 channels: 3
  ...
  (instruments
    (instrument id: 1 name: "ring-stone, sounding" patch: (bell fm-index: 0.9 fm-mod: 1.41 attack: 0.25 decay: 4.5 sustain: 0.0 release: 2.0) volume: 50 send: 0.6)
    (instrument id: 2 name: "its partials" patch: (bell fm-index: 0.6 fm-mod: 2.0 attack: 0.6 decay: 3.5 sustain: 0.0 release: 1.5) volume: 34 send: 0.6))
  (patterns
