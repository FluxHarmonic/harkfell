...
- **Exits are open edges and must match their neighbour's edge cell for cell.** An edge with no room beyond it is closed. So the top row of a region's top rooms is rock until a room exists above it.
